...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "localhost 127.0.0.1 [::1]").split(" ") + os.environ.get('WEBSITE_HOSTNAME').split(" ")
CSRF_TRUSTED_ORIGINS = os.environ.get("CSRF_TRUSTED_ORIGINS", "http://localhost").split(" ") + os.environ.get('WEBSITE_HOSTNAME').split(" ")
