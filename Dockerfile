...
# install remote ldap
RUN git clone https://github.com/apmorton/django-remote-auth-ldap.git /tmp/django-remote-auth-ldap && cd /tmp/django-remote-auth-ldap && python setup.py install && cd ${APP_DIR} && rm -rf /tmp
